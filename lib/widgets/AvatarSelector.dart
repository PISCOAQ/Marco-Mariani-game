...
class Avatarselector extends StatelessWidget {
  ...
  // Mappa degli avatar disponibili con il loro ID e path
  final Map<int, String> avatars = const {
  ...
  // Metodo privato per costruire il singolo riquadro dell'avatar 
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: AnimatedContainer(
          ...
          // Cambiato: Sfondo semi-trasparente (giallognolo se selezionato, bianco se no)
...
Widget build(BuildContext context) {
  return Center(
    child: Container(
      ...
      child: Stack(
        children: [
          // Contenuto principale (testo, avatar, pulsante conferma)
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const SizedBox(height: 20), // spazio per l'X
              const Text(
              ...
              Row(
                ...
                children: avatars.entries.map((entry) {
                  return _buildAvatarTile(context, entry.key, entry.value);
                }).toList(),
              ),
          ...
          // Pulsante X in alto a destra del container
          Positioned(
            top: 0,
            right: 0,
